        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Numberofplayers = table.Column<int>(name: "Number_of_players", type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardGameComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoardGameComments_BoardGames_BoardGameId",
                        column: x => x.BoardGameId,
                        principalTable: "BoardGames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardGameComments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_BoardGames_BoardGameId",
                        column: x => x.BoardGameId,
                        principalTable: "BoardGames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "BoardGames",
                columns: new[] { "Id", "Name", "Number_of_players", "UserId", "availability" },
                values: new object[,]
                {
                    { 1, "Brzdek nie draznij smoka", 4, null, null },
                    { 2, "Everdell", 4, null, null },
                    { 3, "Nemesis", 5, null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardGameComments_BoardGameId",
                table: "BoardGameComments",
                column: "BoardGameId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardGameComments_UserId",
                table: "BoardGameComments",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_BoardGameId",
                table: "Transactions",
                column: "BoardGameId");
